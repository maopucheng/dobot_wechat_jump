...
def dobot_jump(time,x=200,y=0,z=0):
    ...
    lastIndex = dType.SetPTPCmd(api, dType.PTPMode.PTPMOVJXYZMode, x, y, z+40, 0, 1)[0]
    ...
    #print("exit dobot_jump()")

#初始化dobot
def initDobot():
    #print("pcat:enter init()\n")
...
def jump(distance, delta_piece_y):
    ...
    touch_time = press_time + delta_piece_y
    print("pcat: touch time = " + str(touch_time))
    ...
    #用dobot的方式执行jump
    #注意：时间是秒，所以除1000，pcat
    dobot_jump(touch_time/1000,200,0,-73.5)
